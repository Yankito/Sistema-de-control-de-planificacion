...
export const useAssetDetail = (data: FallaRow[], assetName: string) => {
    ...
    // 1. Filtrar datos del activo (Base Histórica)
    ...
    // 2. Datos para la Tabla y KPIs (Filtrados si hay selección)
    ...
    // 4. Datos para el Gráfico (Siempre muestra el panorama completo)
