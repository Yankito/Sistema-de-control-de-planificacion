...
export const useFallasData = (data: FallaRow[]) => {
  ...
  const config = useMemo(() => {
    ...
    const plantas = Array.from(new Set(data.map(d => d.planta)))
